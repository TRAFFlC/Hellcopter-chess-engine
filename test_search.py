...
move = engine.find_best_move_c(fen, 0.1, 0.0, 0.0, 0, 0, 1, ctypes.byref(nodes), game_history, 0)

sq_names = 'a1b1c1d1e1f1g1h1a2b2c2d2e2f2g2h2a3b3c3d3e3f3g3h3a4b4c4d4e4f4g4h4a5b5c5d5e5f5g5h5a6b6c6d6e6f6g6h6a7b7c7d7e8f8g8h8'

def sq_to_name(sq):
    return sq_names[sq*2:sq*2+2]

print(f"最佳着法: {sq_to_name(move.from_sq)}{sq_to_name(move.to_sq)}")
print(f"分数: {move.score}")
